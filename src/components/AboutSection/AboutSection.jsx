      ...
      <div className="container">
        <div className='nosotros-grid'>
          ...
          >
            ...
            >
              Conoce <span className='nosotros-highlight'>Exodium</span>
            </motion.h2>
            ...
            >
              En <strong>Exodium Gym</strong> no solo transformamos cuerpos, forjamos mentalidades ganadoras. Somos el espacio donde los límites se rompen y cada entrenamiento es un paso hacia la mejor versión de ti.
            </motion.p>
